...
public static partial class Builders
{
    ...
    public static ExperimentalAcrylicMaterialBuilder ExperimentalAcrylicMaterial()
    ...
    /// <returns>The new instance of the <see cref="Avalonia.Media.ExperimentalAcrylicMaterial"/> class.</returns>
    public static ExperimentalAcrylicMaterialBuilder ExperimentalAcrylicMaterial(out ElementRef<Avalonia.Media.ExperimentalAcrylicMaterial> @ref)
    {
