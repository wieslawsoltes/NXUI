...
public static partial class Builders
{
    ...
    public static GeometryDrawingBuilder GeometryDrawing()
    ...
    /// <returns>The new instance of the <see cref="Avalonia.Media.GeometryDrawing"/> class.</returns>
    public static GeometryDrawingBuilder GeometryDrawing(out ElementRef<Avalonia.Media.GeometryDrawing> @ref)
    {
