...
public static partial class SolidColorBrushExtensions
{
    ...
    /// <summary>
    /// Records a binding to <see cref="Avalonia.Media.SolidColorBrush.ColorProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    ...
    {
        return builder.WithBinding(PropertyMetadata.SolidColorBrush_Color, Avalonia.Media.SolidColorBrush.ColorProperty, binding, mode, priority);
    }

    /// <summary>
    /// Records an observable binding to <see cref="Avalonia.Media.SolidColorBrush.ColorProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
