...
public static partial class SkewTransformExtensions
{
    ...
    public static ElementRef<Avalonia.Media.SkewTransform> AngleX(this ElementRef<Avalonia.Media.SkewTransform> elementRef, System.Double value)
    {
        return elementRef.SetValue(Avalonia.Media.SkewTransform.AngleXProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.SkewTransform.AngleXProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    /// <param name="priority">The target binding priority.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<Avalonia.Media.SkewTransform> AngleX(
        this ElementRef<Avalonia.Media.SkewTransform> elementRef,
        Avalonia.Data.IBinding binding,
        Avalonia.Data.BindingMode mode = Avalonia.Data.BindingMode.TwoWay,
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue)
    {
        return elementRef.SetBinding(Avalonia.Media.SkewTransform.AngleXProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.SkewTransform.AngleXProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<Avalonia.Media.SkewTransform> AngleY(this ElementRef<Avalonia.Media.SkewTransform> elementRef, System.Double value)
    {
        return elementRef.SetValue(Avalonia.Media.SkewTransform.AngleYProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.SkewTransform.AngleYProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    /// <param name="priority">The target binding priority.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<Avalonia.Media.SkewTransform> AngleY(
        this ElementRef<Avalonia.Media.SkewTransform> elementRef,
        Avalonia.Data.IBinding binding,
        Avalonia.Data.BindingMode mode = Avalonia.Data.BindingMode.TwoWay,
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue)
    {
        return elementRef.SetBinding(Avalonia.Media.SkewTransform.AngleYProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.SkewTransform.AngleYProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
