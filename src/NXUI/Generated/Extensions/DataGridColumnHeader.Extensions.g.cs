...
public static partial class DataGridColumnHeaderExtensions
{
    ...
    public static ElementBuilder<T> SeparatorBrush<T>(this ElementBuilder<T> builder, Avalonia.Media.IBrush value) where T : Avalonia.Controls.DataGridColumnHeader
    {
        return builder.WithValue(PropertyMetadata.DataGridColumnHeader_SeparatorBrush, Avalonia.Controls.DataGridColumnHeader.SeparatorBrushProperty, value);
    }

    /// <summary>
    /// Records a binding to <see cref="Avalonia.Controls.DataGridColumnHeader.SeparatorBrushProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    ...
    {
        return builder.WithBinding(PropertyMetadata.DataGridColumnHeader_SeparatorBrush, Avalonia.Controls.DataGridColumnHeader.SeparatorBrushProperty, binding, mode, priority);
    }

    /// <summary>
    /// Records an observable binding to <see cref="Avalonia.Controls.DataGridColumnHeader.SeparatorBrushProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    ...
    public static ElementRef<T> SeparatorBrush<T>(this ElementRef<T> elementRef, Avalonia.Media.IBrush value) where T : Avalonia.Controls.DataGridColumnHeader
    {
        return elementRef.SetValue(Avalonia.Controls.DataGridColumnHeader.SeparatorBrushProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Controls.DataGridColumnHeader.SeparatorBrushProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<T> SeparatorBrush<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Controls.DataGridColumnHeader
    {
        return elementRef.SetBinding(Avalonia.Controls.DataGridColumnHeader.SeparatorBrushProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Controls.DataGridColumnHeader.SeparatorBrushProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The builder instance.</returns>
    public static ElementBuilder<T> AreSeparatorsVisible<T>(this ElementBuilder<T> builder, System.Boolean value) where T : Avalonia.Controls.DataGridColumnHeader
    {
        return builder.WithValue(PropertyMetadata.DataGridColumnHeader_AreSeparatorsVisible, Avalonia.Controls.DataGridColumnHeader.AreSeparatorsVisibleProperty, value);
    }

    /// <summary>
    /// Records a binding to <see cref="Avalonia.Controls.DataGridColumnHeader.AreSeparatorsVisibleProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementBuilder<T> AreSeparatorsVisible<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Controls.DataGridColumnHeader
    {
        return builder.WithBinding(PropertyMetadata.DataGridColumnHeader_AreSeparatorsVisible, Avalonia.Controls.DataGridColumnHeader.AreSeparatorsVisibleProperty, binding, mode, priority);
    }

    /// <summary>
    /// Records an observable binding to <see cref="Avalonia.Controls.DataGridColumnHeader.AreSeparatorsVisibleProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<T> AreSeparatorsVisible<T>(this ElementRef<T> elementRef, System.Boolean value) where T : Avalonia.Controls.DataGridColumnHeader
    {
        return elementRef.SetValue(Avalonia.Controls.DataGridColumnHeader.AreSeparatorsVisibleProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Controls.DataGridColumnHeader.AreSeparatorsVisibleProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<T> AreSeparatorsVisible<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Controls.DataGridColumnHeader
    {
        return elementRef.SetBinding(Avalonia.Controls.DataGridColumnHeader.AreSeparatorsVisibleProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Controls.DataGridColumnHeader.AreSeparatorsVisibleProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
