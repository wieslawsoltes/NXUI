...
public static partial class FlyoutBaseExtensions
{
    ...
    /// <summary>
    /// Records a binding to <see cref="Avalonia.Controls.Primitives.FlyoutBase.AttachedFlyoutProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    ...
    {
        return builder.WithBinding(PropertyMetadata.FlyoutBase_AttachedFlyout, Avalonia.Controls.Primitives.FlyoutBase.AttachedFlyoutProperty, binding, mode, priority);
    }

    /// <summary>
    /// Records an observable binding to <see cref="Avalonia.Controls.Primitives.FlyoutBase.AttachedFlyoutProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    ...
    public static ElementRef<T> AttachedFlyout<T>(this ElementRef<T> elementRef, Avalonia.Controls.Primitives.FlyoutBase? value) where T : Avalonia.Controls.Control
    {
        return elementRef.SetValue(Avalonia.Controls.Primitives.FlyoutBase.AttachedFlyoutProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Controls.Primitives.FlyoutBase.AttachedFlyoutProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<T> AttachedFlyout<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Controls.Control
    {
        return elementRef.SetBinding(Avalonia.Controls.Primitives.FlyoutBase.AttachedFlyoutProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Controls.Primitives.FlyoutBase.AttachedFlyoutProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
