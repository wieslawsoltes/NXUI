...
public static partial class BrushExtensions
{
    ...
    public static ElementBuilder<T> Opacity<T>(this ElementBuilder<T> builder, System.Double value) where T : Avalonia.Media.Brush
    {
        return builder.WithValue(PropertyMetadata.Brush_Opacity, Avalonia.Media.Brush.OpacityProperty, value);
    }

    /// <summary>
    /// Records a binding to <see cref="Avalonia.Media.Brush.OpacityProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    ...
    {
        return builder.WithBinding(PropertyMetadata.Brush_Opacity, Avalonia.Media.Brush.OpacityProperty, binding, mode, priority);
    }

    /// <summary>
    /// Records an observable binding to <see cref="Avalonia.Media.Brush.OpacityProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    ...
    public static ElementRef<T> Opacity<T>(this ElementRef<T> elementRef, System.Double value) where T : Avalonia.Media.Brush
    {
        return elementRef.SetValue(Avalonia.Media.Brush.OpacityProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.Brush.OpacityProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<T> Opacity<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.Brush
    {
        return elementRef.SetBinding(Avalonia.Media.Brush.OpacityProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.Brush.OpacityProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <summary>
    /// Records a binding to <see cref="Avalonia.Media.Brush.TransformProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementBuilder<T> Transform<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.Brush
    {
        return builder.WithBinding(PropertyMetadata.Brush_Transform, Avalonia.Media.Brush.TransformProperty, binding, mode, priority);
    }

    /// <summary>
    /// Records an observable binding to <see cref="Avalonia.Media.Brush.TransformProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<T> Transform<T>(this ElementRef<T> elementRef, Avalonia.Media.ITransform? value) where T : Avalonia.Media.Brush
    {
        return elementRef.SetValue(Avalonia.Media.Brush.TransformProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.Brush.TransformProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<T> Transform<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.Brush
    {
        return elementRef.SetBinding(Avalonia.Media.Brush.TransformProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.Brush.TransformProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The builder instance.</returns>
    public static ElementBuilder<T> TransformOrigin<T>(this ElementBuilder<T> builder, Avalonia.RelativePoint value) where T : Avalonia.Media.Brush
    {
        return builder.WithValue(PropertyMetadata.Brush_TransformOrigin, Avalonia.Media.Brush.TransformOriginProperty, value);
    }

    /// <summary>
    /// Records a binding to <see cref="Avalonia.Media.Brush.TransformOriginProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    /// <param name="priority">The target binding priority.</param>
    /// <returns>The builder instance.</returns>
    public static ElementBuilder<T> TransformOrigin<T>(
        this ElementBuilder<T> builder,
        Avalonia.Data.BindingBase binding,
        Avalonia.Data.BindingMode mode = Avalonia.Data.BindingMode.TwoWay,
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.Brush
    {
        return builder.WithBinding(PropertyMetadata.Brush_TransformOrigin, Avalonia.Media.Brush.TransformOriginProperty, binding, mode, priority);
    }

    /// <summary>
    /// Records an observable binding to <see cref="Avalonia.Media.Brush.TransformOriginProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<T> TransformOrigin<T>(this ElementRef<T> elementRef, Avalonia.RelativePoint value) where T : Avalonia.Media.Brush
    {
        return elementRef.SetValue(Avalonia.Media.Brush.TransformOriginProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.Brush.TransformOriginProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    /// <param name="priority">The target binding priority.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<T> TransformOrigin<T>(
        this ElementRef<T> elementRef,
        Avalonia.Data.BindingBase binding,
        Avalonia.Data.BindingMode mode = Avalonia.Data.BindingMode.TwoWay,
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.Brush
    {
        return elementRef.SetBinding(Avalonia.Media.Brush.TransformOriginProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.Brush.TransformOriginProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static Avalonia.Data.BindingBase BindTransformOrigin(
        this Avalonia.Media.Brush obj,
        Avalonia.Data.BindingMode mode = Avalonia.Data.BindingMode.TwoWay,
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue)
    {
