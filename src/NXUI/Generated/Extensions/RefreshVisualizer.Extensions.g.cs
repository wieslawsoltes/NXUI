...
public static partial class RefreshVisualizerExtensions
{
    ...
    public static Avalonia.Data.BindingBase BindRefreshVisualizerState(
    ...
    public static ElementRef<T> Orientation<T>(this ElementRef<T> elementRef, Avalonia.Controls.RefreshVisualizerOrientation value) where T : Avalonia.Controls.RefreshVisualizer
    {
        return elementRef.SetValue(Avalonia.Controls.RefreshVisualizer.OrientationProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Controls.RefreshVisualizer.OrientationProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<T> Orientation<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Controls.RefreshVisualizer
    {
        return elementRef.SetBinding(Avalonia.Controls.RefreshVisualizer.OrientationProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Controls.RefreshVisualizer.OrientationProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
