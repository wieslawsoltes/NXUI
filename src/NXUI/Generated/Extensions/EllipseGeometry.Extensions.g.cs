...
public static partial class EllipseGeometryExtensions
{
    ...
    public static ElementBuilder<T> Rect<T>(this ElementBuilder<T> builder, Avalonia.Rect value) where T : Avalonia.Media.EllipseGeometry
    {
        return builder.WithValue(PropertyMetadata.EllipseGeometry_Rect, Avalonia.Media.EllipseGeometry.RectProperty, value);
    }

    /// <summary>
    /// Records a binding to <see cref="Avalonia.Media.EllipseGeometry.RectProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    ...
    {
        return builder.WithBinding(PropertyMetadata.EllipseGeometry_Rect, Avalonia.Media.EllipseGeometry.RectProperty, binding, mode, priority);
    }

    /// <summary>
    /// Records an observable binding to <see cref="Avalonia.Media.EllipseGeometry.RectProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    ...
    public static ElementRef<T> Rect<T>(this ElementRef<T> elementRef, Avalonia.Rect value) where T : Avalonia.Media.EllipseGeometry
    {
        return elementRef.SetValue(Avalonia.Media.EllipseGeometry.RectProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.EllipseGeometry.RectProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<T> Rect<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.EllipseGeometry
    {
        return elementRef.SetBinding(Avalonia.Media.EllipseGeometry.RectProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.EllipseGeometry.RectProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The builder instance.</returns>
    public static ElementBuilder<T> RadiusX<T>(this ElementBuilder<T> builder, System.Double value) where T : Avalonia.Media.EllipseGeometry
    {
        return builder.WithValue(PropertyMetadata.EllipseGeometry_RadiusX, Avalonia.Media.EllipseGeometry.RadiusXProperty, value);
    }

    /// <summary>
    /// Records a binding to <see cref="Avalonia.Media.EllipseGeometry.RadiusXProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementBuilder<T> RadiusX<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.EllipseGeometry
    {
        return builder.WithBinding(PropertyMetadata.EllipseGeometry_RadiusX, Avalonia.Media.EllipseGeometry.RadiusXProperty, binding, mode, priority);
    }

    /// <summary>
    /// Records an observable binding to <see cref="Avalonia.Media.EllipseGeometry.RadiusXProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<T> RadiusX<T>(this ElementRef<T> elementRef, System.Double value) where T : Avalonia.Media.EllipseGeometry
    {
        return elementRef.SetValue(Avalonia.Media.EllipseGeometry.RadiusXProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.EllipseGeometry.RadiusXProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<T> RadiusX<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.EllipseGeometry
    {
        return elementRef.SetBinding(Avalonia.Media.EllipseGeometry.RadiusXProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.EllipseGeometry.RadiusXProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The builder instance.</returns>
    public static ElementBuilder<T> RadiusY<T>(this ElementBuilder<T> builder, System.Double value) where T : Avalonia.Media.EllipseGeometry
    {
        return builder.WithValue(PropertyMetadata.EllipseGeometry_RadiusY, Avalonia.Media.EllipseGeometry.RadiusYProperty, value);
    }

    /// <summary>
    /// Records a binding to <see cref="Avalonia.Media.EllipseGeometry.RadiusYProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementBuilder<T> RadiusY<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.EllipseGeometry
    {
        return builder.WithBinding(PropertyMetadata.EllipseGeometry_RadiusY, Avalonia.Media.EllipseGeometry.RadiusYProperty, binding, mode, priority);
    }

    /// <summary>
    /// Records an observable binding to <see cref="Avalonia.Media.EllipseGeometry.RadiusYProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<T> RadiusY<T>(this ElementRef<T> elementRef, System.Double value) where T : Avalonia.Media.EllipseGeometry
    {
        return elementRef.SetValue(Avalonia.Media.EllipseGeometry.RadiusYProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.EllipseGeometry.RadiusYProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<T> RadiusY<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.EllipseGeometry
    {
        return elementRef.SetBinding(Avalonia.Media.EllipseGeometry.RadiusYProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.EllipseGeometry.RadiusYProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The builder instance.</returns>
    public static ElementBuilder<T> Center<T>(this ElementBuilder<T> builder, Avalonia.Point value) where T : Avalonia.Media.EllipseGeometry
    {
        return builder.WithValue(PropertyMetadata.EllipseGeometry_Center, Avalonia.Media.EllipseGeometry.CenterProperty, value);
    }

    /// <summary>
    /// Records a binding to <see cref="Avalonia.Media.EllipseGeometry.CenterProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    /// <param name="priority">The target binding priority.</param>
    /// <returns>The builder instance.</returns>
    public static ElementBuilder<T> Center<T>(
        this ElementBuilder<T> builder,
        Avalonia.Data.IBinding binding,
        Avalonia.Data.BindingMode mode = Avalonia.Data.BindingMode.TwoWay,
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.EllipseGeometry
    {
        return builder.WithBinding(PropertyMetadata.EllipseGeometry_Center, Avalonia.Media.EllipseGeometry.CenterProperty, binding, mode, priority);
    }

    /// <summary>
    /// Records an observable binding to <see cref="Avalonia.Media.EllipseGeometry.CenterProperty"/> for hot reload builds.
    /// </summary>
    /// <param name="builder">The target builder.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<T> Center<T>(this ElementRef<T> elementRef, Avalonia.Point value) where T : Avalonia.Media.EllipseGeometry
    {
        return elementRef.SetValue(Avalonia.Media.EllipseGeometry.CenterProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.EllipseGeometry.CenterProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    /// <param name="priority">The target binding priority.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<T> Center<T>(
        this ElementRef<T> elementRef,
        Avalonia.Data.IBinding binding,
        Avalonia.Data.BindingMode mode = Avalonia.Data.BindingMode.TwoWay,
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Media.EllipseGeometry
    {
        return elementRef.SetBinding(Avalonia.Media.EllipseGeometry.CenterProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.EllipseGeometry.CenterProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
