...
public static partial class NativeMenuBarExtensions
{
    ...
    public static ElementRef<T> EnableMenuItemClickForwarding<T>(this ElementRef<T> elementRef, System.Boolean value) where T : Avalonia.Controls.MenuItem
    {
        return elementRef.SetValue(Avalonia.Controls.NativeMenuBar.EnableMenuItemClickForwardingProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Controls.NativeMenuBar.EnableMenuItemClickForwardingProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    /// <param name="priority">The target binding priority.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<T> EnableMenuItemClickForwarding<T>(
        this ElementRef<T> elementRef,
        Avalonia.Data.IBinding binding,
        Avalonia.Data.BindingMode mode = Avalonia.Data.BindingMode.TwoWay,
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Controls.MenuItem
    {
        return elementRef.SetBinding(Avalonia.Controls.NativeMenuBar.EnableMenuItemClickForwardingProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Controls.NativeMenuBar.EnableMenuItemClickForwardingProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
