...
public static partial class ConicGradientBrushExtensions
{
    ...
    public static ElementRef<Avalonia.Media.ConicGradientBrush> Center(this ElementRef<Avalonia.Media.ConicGradientBrush> elementRef, Avalonia.RelativePoint value)
    {
        return elementRef.SetValue(Avalonia.Media.ConicGradientBrush.CenterProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.ConicGradientBrush.CenterProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<Avalonia.Media.ConicGradientBrush> Center(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue)
    {
        return elementRef.SetBinding(Avalonia.Media.ConicGradientBrush.CenterProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.ConicGradientBrush.CenterProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <param name="value">The value.</param>
    /// <returns>The element reference.</returns>
    public static ElementRef<Avalonia.Media.ConicGradientBrush> Angle(this ElementRef<Avalonia.Media.ConicGradientBrush> elementRef, System.Double value)
    {
        return elementRef.SetValue(Avalonia.Media.ConicGradientBrush.AngleProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.ConicGradientBrush.AngleProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<Avalonia.Media.ConicGradientBrush> Angle(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue)
    {
        return elementRef.SetBinding(Avalonia.Media.ConicGradientBrush.AngleProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.ConicGradientBrush.AngleProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
