...
public static partial class VisualBrushExtensions
{
    ...
    public static ElementRef<Avalonia.Media.VisualBrush> Visual(this ElementRef<Avalonia.Media.VisualBrush> elementRef, Avalonia.Visual? value)
    {
        return elementRef.SetValue(Avalonia.Media.VisualBrush.VisualProperty, value);
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Media.VisualBrush.VisualProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static ElementRef<Avalonia.Media.VisualBrush> Visual(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue)
    {
        return elementRef.SetBinding(Avalonia.Media.VisualBrush.VisualProperty, binding, mode, priority);
    }

    /// <summary>
    /// Sets an observable binding to <see cref="Avalonia.Media.VisualBrush.VisualProperty"/> on a referenced control.
    /// </summary>
    /// <param name="elementRef">The target element reference.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
