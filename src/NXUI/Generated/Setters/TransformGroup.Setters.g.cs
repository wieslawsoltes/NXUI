...
public static partial class TransformGroupSetters
{
    ...
    public static ElementBuilder<Style> SetTransformGroupChildren(this ElementBuilder<Style> builder, Avalonia.Media.Transforms value)
    {
    ...
    public static ElementBuilder<KeyFrame> SetTransformGroupChildren(this ElementBuilder<KeyFrame> builder, Avalonia.Media.Transforms value)
    {
    ...
    /// <returns>The style builder.</returns>
    public static ElementBuilder<Style> SetTransformGroupChildren(this ElementBuilder<Style> builder, IObservable<Avalonia.Media.Transforms> observable)
    {
        return builder.WithAction(style =>
        {
    ...
    /// <param name="observable">The property observable.</param>
    /// <returns>The keyframe builder.</returns>
    public static ElementBuilder<KeyFrame> SetTransformGroupChildren(this ElementBuilder<KeyFrame> builder, IObservable<Avalonia.Media.Transforms> observable)
    {
        return builder.WithAction(keyFrame =>
        {
    ...
    /// <returns>The style builder.</returns>
    public static ElementBuilder<Style> SetTransformGroupChildren(this ElementBuilder<Style> builder, Avalonia.Data.IBinding binding)
    {
        return builder.WithAction(style =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The keyframe builder.</returns>
    public static ElementBuilder<KeyFrame> SetTransformGroupChildren(this ElementBuilder<KeyFrame> builder, Avalonia.Data.IBinding binding)
    {
        return builder.WithAction(keyFrame =>
        {
