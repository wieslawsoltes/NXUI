...
public static partial class DecoratorSetters
{
    ...
    /// <returns>The style builder.</returns>
    public static StyleBuilder SetDecoratorChild(this StyleBuilder builder, Avalonia.Data.BindingBase binding)
    {
        return builder.WithAction(style =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The keyframe builder.</returns>
    public static KeyFrameBuilder SetDecoratorChild(this KeyFrameBuilder builder, Avalonia.Data.BindingBase binding)
    {
        return builder.WithAction(keyFrame =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The target style object reference.</returns>
    public static Style SetDecoratorChild(this Style style, Avalonia.Data.BindingBase binding)
    {
        style.Setters.Add(new Setter(Avalonia.Controls.Decorator.ChildProperty, binding));
        return style;
    }
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The target keyframe object reference.</returns>
    public static KeyFrame SetDecoratorChild(this KeyFrame keyFrame, Avalonia.Data.BindingBase binding)
    {
        keyFrame.Setters.Add(new Setter(Avalonia.Controls.Decorator.ChildProperty, binding));
        return keyFrame;
    }
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The style builder.</returns>
    public static StyleBuilder SetDecoratorPadding(this StyleBuilder builder, Avalonia.Data.BindingBase binding)
    {
        return builder.WithAction(style =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The keyframe builder.</returns>
    public static KeyFrameBuilder SetDecoratorPadding(this KeyFrameBuilder builder, Avalonia.Data.BindingBase binding)
    {
        return builder.WithAction(keyFrame =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The target style object reference.</returns>
    public static Style SetDecoratorPadding(this Style style, Avalonia.Data.BindingBase binding)
    {
        style.Setters.Add(new Setter(Avalonia.Controls.Decorator.PaddingProperty, binding));
        return style;
    }
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The target keyframe object reference.</returns>
    public static KeyFrame SetDecoratorPadding(this KeyFrame keyFrame, Avalonia.Data.BindingBase binding)
    {
        keyFrame.Setters.Add(new Setter(Avalonia.Controls.Decorator.PaddingProperty, binding));
        return keyFrame;
    }
