...
public static partial class DataGridFrozenGridSetters
{
    ...
    /// <returns>The style builder.</returns>
    public static StyleBuilder SetDataGridFrozenGridIsFrozen(this StyleBuilder builder, Avalonia.Data.IBinding binding)
    {
        return builder.WithAction(style =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The keyframe builder.</returns>
    public static KeyFrameBuilder SetDataGridFrozenGridIsFrozen(this KeyFrameBuilder builder, Avalonia.Data.IBinding binding)
    {
        return builder.WithAction(keyFrame =>
        {
