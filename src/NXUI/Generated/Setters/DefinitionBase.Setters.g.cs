...
public static partial class DefinitionBaseSetters
{
    ...
    /// <returns>The style builder.</returns>
    public static StyleBuilder SetDefinitionBaseSharedSizeGroup(this StyleBuilder builder, Avalonia.Data.BindingBase binding)
    {
        return builder.WithAction(style =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The keyframe builder.</returns>
    public static KeyFrameBuilder SetDefinitionBaseSharedSizeGroup(this KeyFrameBuilder builder, Avalonia.Data.BindingBase binding)
    {
        return builder.WithAction(keyFrame =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The target style object reference.</returns>
    public static Style SetDefinitionBaseSharedSizeGroup(this Style style, Avalonia.Data.BindingBase binding)
    {
        style.Setters.Add(new Setter(Avalonia.Controls.DefinitionBase.SharedSizeGroupProperty, binding));
        return style;
    }
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The target keyframe object reference.</returns>
    public static KeyFrame SetDefinitionBaseSharedSizeGroup(this KeyFrame keyFrame, Avalonia.Data.BindingBase binding)
    {
        keyFrame.Setters.Add(new Setter(Avalonia.Controls.DefinitionBase.SharedSizeGroupProperty, binding));
        return keyFrame;
    }
