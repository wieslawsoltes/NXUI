...
public static partial class ListBoxItemSetters
{
    ...
    /// <returns>The style builder.</returns>
    public static StyleBuilder SetListBoxItemIsSelected(this StyleBuilder builder, Avalonia.Data.IBinding binding)
    {
        return builder.WithAction(style =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The keyframe builder.</returns>
    public static KeyFrameBuilder SetListBoxItemIsSelected(this KeyFrameBuilder builder, Avalonia.Data.IBinding binding)
    {
        return builder.WithAction(keyFrame =>
        {
