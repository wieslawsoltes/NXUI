...
public static partial class PullGestureRecognizerSetters
{
    ...
    /// <returns>The style builder.</returns>
    public static StyleBuilder SetPullGestureRecognizerPullDirection(this StyleBuilder builder, Avalonia.Data.BindingBase binding)
    {
        return builder.WithAction(style =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The keyframe builder.</returns>
    public static KeyFrameBuilder SetPullGestureRecognizerPullDirection(this KeyFrameBuilder builder, Avalonia.Data.BindingBase binding)
    {
        return builder.WithAction(keyFrame =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The target style object reference.</returns>
    public static Style SetPullGestureRecognizerPullDirection(this Style style, Avalonia.Data.BindingBase binding)
    {
        style.Setters.Add(new Setter(Avalonia.Input.PullGestureRecognizer.PullDirectionProperty, binding));
        return style;
    }
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The target keyframe object reference.</returns>
    public static KeyFrame SetPullGestureRecognizerPullDirection(this KeyFrame keyFrame, Avalonia.Data.BindingBase binding)
    {
        keyFrame.Setters.Add(new Setter(Avalonia.Input.PullGestureRecognizer.PullDirectionProperty, binding));
        return keyFrame;
    }
