...
public static partial class RadioButtonSetters
{
    ...
    /// <summary>
    /// Adds a builder-recorded keyframe setter for an <see cref="Avalonia.Controls.RadioButton.GroupNameProperty"/>.
    /// </summary>
    ...
    /// <summary>
    /// Adds a builder-recorded keyframe setter for an <see cref="Avalonia.Controls.RadioButton.GroupNameProperty"/> using an observable source.
    /// </summary>
    /// <param name="builder">The keyframe builder.</param>
    /// <param name="observable">The property observable.</param>
    /// <returns>The keyframe builder.</returns>
    ...
    /// <returns>The style builder.</returns>
    public static StyleBuilder SetRadioButtonGroupName(this StyleBuilder builder, Avalonia.Data.BindingBase binding)
    {
        return builder.WithAction(style =>
        {
    ...
    /// <summary>
    /// Adds a builder-recorded keyframe setter for an <see cref="Avalonia.Controls.RadioButton.GroupNameProperty"/> using a binding.
    /// </summary>
    /// <param name="builder">The keyframe builder.</param>
    /// <param name="binding">The property binding.</param>
    /// <returns>The keyframe builder.</returns>
    public static KeyFrameBuilder SetRadioButtonGroupName(this KeyFrameBuilder builder, Avalonia.Data.BindingBase binding)
    {
        return builder.WithAction(keyFrame =>
        {
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The target style object reference.</returns>
    public static Style SetRadioButtonGroupName(this Style style, Avalonia.Data.BindingBase binding)
    {
        style.Setters.Add(new Setter(Avalonia.Controls.RadioButton.GroupNameProperty, binding));
        return style;
    }
    ...
    /// <param name="binding">The property binding.</param>
    /// <returns>The target keyframe object reference.</returns>
    public static KeyFrame SetRadioButtonGroupName(this KeyFrame keyFrame, Avalonia.Data.BindingBase binding)
    {
        keyFrame.Setters.Add(new Setter(Avalonia.Controls.RadioButton.GroupNameProperty, binding));
        return keyFrame;
    }
