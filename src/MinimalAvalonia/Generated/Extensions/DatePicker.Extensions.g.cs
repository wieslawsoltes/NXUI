...
/// <summary>
/// The minimal avalonia <see cref="Avalonia.Controls.DatePicker"/> class property extension methods.
/// </summary>
public static partial class DatePickerExtensions
{
    ...
    // Avalonia.Controls.DatePicker.HeaderProperty

    /// <summary>
    /// Sets a <see cref="Avalonia.Controls.DatePicker.HeaderProperty"/> value.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="value">The value.</param>
    /// <typeparam name="T">The type of the target object.</typeparam>
    ...
    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Controls.DatePicker.HeaderProperty"/> with binding source value.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static T Header<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Controls.DatePicker
    {
        var descriptor = Avalonia.Controls.DatePicker.HeaderProperty.Bind().WithMode(mode).WithPriority(priority);
        obj[descriptor] = binding;
        return obj;
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Controls.DatePicker.HeaderProperty"/> with observable source value.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <summary>
    /// Makes a <see cref="Avalonia.Controls.DatePicker.HeaderProperty"/> binding.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="mode">The target binding mode.</param>
    /// <param name="priority">The target binding priority.</param>
    /// <returns>A <see cref="Avalonia.Controls.DatePicker.HeaderProperty"/> binding.</returns>
    ...
    /// <summary>
    /// Gets an observable for an <see cref="Avalonia.Controls.DatePicker.HeaderProperty"/>.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <returns>
    /// An observable which fires immediately with the current value of the property on the
    ...
    /// <summary>
    /// Sets a handler with an observable for an <see cref="Avalonia.Controls.DatePicker.HeaderProperty"/>.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="handler">The handler with target object and observable with the current value of the property.</param>
    /// <typeparam name="T">The type of the target object.</typeparam>
    ...
    // Avalonia.Controls.DatePicker.HeaderTemplateProperty

    /// <summary>
    /// Sets a <see cref="Avalonia.Controls.DatePicker.HeaderTemplateProperty"/> value.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="value">The value.</param>
    /// <typeparam name="T">The type of the target object.</typeparam>
    ...
    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Controls.DatePicker.HeaderTemplateProperty"/> with binding source value.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static T HeaderTemplate<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Controls.DatePicker
    {
        var descriptor = Avalonia.Controls.DatePicker.HeaderTemplateProperty.Bind().WithMode(mode).WithPriority(priority);
        obj[descriptor] = binding;
        return obj;
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Controls.DatePicker.HeaderTemplateProperty"/> with observable source value.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <summary>
    /// Makes a <see cref="Avalonia.Controls.DatePicker.HeaderTemplateProperty"/> binding.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="mode">The target binding mode.</param>
    /// <param name="priority">The target binding priority.</param>
    /// <returns>A <see cref="Avalonia.Controls.DatePicker.HeaderTemplateProperty"/> binding.</returns>
    ...
    /// <summary>
    /// Gets an observable for an <see cref="Avalonia.Controls.DatePicker.HeaderTemplateProperty"/>.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <returns>
    /// An observable which fires immediately with the current value of the property on the
    ...
    /// <summary>
    /// Sets a handler with an observable for an <see cref="Avalonia.Controls.DatePicker.HeaderTemplateProperty"/>.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="handler">The handler with target object and observable with the current value of the property.</param>
    /// <typeparam name="T">The type of the target object.</typeparam>
