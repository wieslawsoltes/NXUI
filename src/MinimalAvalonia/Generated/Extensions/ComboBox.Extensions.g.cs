...
/// <summary>
/// The minimal avalonia <see cref="Avalonia.Controls.ComboBox"/> class property extension methods.
/// </summary>
public static partial class ComboBoxExtensions
{
    ...
    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Controls.ComboBox.VirtualizationModeProperty"/> with binding source value.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="binding">The source binding.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    public static T VirtualizationMode<T>(
        ...
        Avalonia.Data.BindingPriority priority = Avalonia.Data.BindingPriority.LocalValue) where T : Avalonia.Controls.ComboBox
    {
        var descriptor = Avalonia.Controls.ComboBox.VirtualizationModeProperty.Bind().WithMode(mode).WithPriority(priority);
        obj[descriptor] = binding;
        return obj;
    }

    /// <summary>
    /// Sets a binding to <see cref="Avalonia.Controls.ComboBox.VirtualizationModeProperty"/> with observable source value.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="observable">The source observable.</param>
    /// <param name="mode">The target binding mode.</param>
    ...
    /// <summary>
    /// Makes a <see cref="Avalonia.Controls.ComboBox.VirtualizationModeProperty"/> binding.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="mode">The target binding mode.</param>
    /// <param name="priority">The target binding priority.</param>
    /// <returns>A <see cref="Avalonia.Controls.ComboBox.VirtualizationModeProperty"/> binding.</returns>
    ...
    /// <summary>
    /// Gets an observable for an <see cref="Avalonia.Controls.ComboBox.VirtualizationModeProperty"/>.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <returns>
    /// An observable which fires immediately with the current value of the property on the
    ...
    /// <summary>
    /// Sets a handler with an observable for an <see cref="Avalonia.Controls.ComboBox.VirtualizationModeProperty"/>.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <param name="handler">The handler with target object and observable with the current value of the property.</param>
    /// <typeparam name="T">The type of the target object.</typeparam>
    ...
    /// <summary>
    /// Sets a <see cref="Avalonia.Controls.ComboBox.VirtualizationModeProperty"/> property value to <see cref="Avalonia.Controls.ItemVirtualizationMode.Simple"/>.
    /// </summary>
    /// <param name="obj">The target object.</param>
    /// <typeparam name="T">The type of the target object.</typeparam>
    /// <returns>The target object reference.</returns>
