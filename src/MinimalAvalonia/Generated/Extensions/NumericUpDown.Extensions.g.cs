...
public static partial class NumericUpDownExtensions
{
    ...
    {
        obj.AddHandler((Avalonia.Interactivity.RoutedEvent<Avalonia.Controls.NumericUpDownValueChangedEventArgs>)Avalonia.Controls.NumericUpDown.ValueChangedEvent, (_, args) => action(obj, args), routes);
        return obj;
    }
    ...
    {
        var observable = obj.GetObservable((Avalonia.Interactivity.RoutedEvent<Avalonia.Controls.NumericUpDownValueChangedEventArgs>)Avalonia.Controls.NumericUpDown.ValueChangedEvent, routes);
        handler(obj, observable);
        return obj;
    }
    ...
    {
        return obj.GetObservable((Avalonia.Interactivity.RoutedEvent<Avalonia.Controls.NumericUpDownValueChangedEventArgs>)Avalonia.Controls.NumericUpDown.ValueChangedEvent, routes);
    }
