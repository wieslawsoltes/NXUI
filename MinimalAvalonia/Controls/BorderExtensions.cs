...
public static class BorderExtensions
{
    ...
    {
        border[Border.CornerRadiusProperty] = new CornerRadius(uniformRadius);
        return border;
    }

    public static T CornerRadius<T>(this T border, double top, double bottom) where T : Border
    {
        border[Border.CornerRadiusProperty] = new CornerRadius(top, bottom);
        return border;
    }
