...
public static class TemplatedControlExtensions
{
    ...
    {
        templatedControl[TemplatedControl.PaddingProperty] = new Thickness(uniformLength);
    ...
    {
        templatedControl[TemplatedControl.PaddingProperty] = new Thickness(horizontal, vertical);
        return templatedControl;
    }
    ...
    {
        templatedControl[TemplatedControl.PaddingProperty] = new Thickness(left, top, right, bottom);
        return templatedControl;
    }
